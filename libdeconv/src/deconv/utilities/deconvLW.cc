...
/*
 *	deconvLW is designed for 3-D deconvolution using the LWdeconvolver and CCube classes.
 *
 *	Four required input arguments:
 *		<image_name> <psf_name> <first_estimated_object_name> <deconvolved_object_name_without suffix>	
...
#define WorkSpaceType                   LWsws	//put LWdws if <DataType> is double.
...
#define Track_Max_In_Object             false	//flag to control whether to track the max intensity of the iterative estimated object
#define Check_Program_Run               true	//flag to control whether to check the deconvolution progress in the terminal


std::string usage = std::string("$deconvLW <image> <psf> <first_estimated_object> <deconvolved_object>\n") + 
